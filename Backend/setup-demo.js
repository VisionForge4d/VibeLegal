...
async function setupDemo() {
  console.log('🚀 Setting up VibeLegal demo data...');
...
LEGAL DISCLAIMER: This document is generated by AI and should be reviewed by a qualified attorney before use. This does not constitute legal advice.`
  ...
  console.log('\n📋 Demo Accounts:');
  console.log('1. demo@vibelegal.com (Password: DemoPassword123!)');
  console.log('2. premium@vibelegal.com (Password: DemoPassword123!)');
  console.log('3. lawyer@lawfirm.com (Password: DemoPassword123!)');
  
  console.log('\n🎯 Demo Features:');
  console.log('- User registration and authentication');
  console.log('- Contract generation with AI (requires OpenAI API key)');
  console.log('- Contract saving and management');
