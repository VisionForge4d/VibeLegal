  ...
  const demoUsers = [
    {
      ...
      password: process.env.DEMO_PASSWORD || 'change-me-before-running',
...
LEGAL DISCLAIMER: This document is generated by AI and should be reviewed by a qualified attorney before use. This does not constitute legal advice.`
  ...
  console.log('\n📋 Demo Accounts:');
  console.log('1. demo@vibelegal.com');
  console.log('2. premium@vibelegal.com');
  console.log('3. lawyer@lawfirm.com');
