                ...
                <div>
                  ...
                  <div className="mt-4 bg-gray-50 border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="text-sm text-gray-700">
                      <p className="font-medium mb-2">Example for Employment Agreement:</p>
                      <p className="italic mb-3">
                        "Software developer position, full-time, $85,000 annual salary, 90-day probation period, 15 days PTO, health insurance, 401k matching, remote work allowed 2 days per week, standard confidentiality and IP assignment clauses, 2-week notice period for termination."
                      </p>
                      
                      <p className="font-medium mb-2">Example for Service Contract:</p>
                      <p className="italic">
                        "Web development services, 3-month project duration, $5,000 total fee paid in 3 installments, includes website design and development, 2 rounds of revisions, client provides content, 30-day warranty period, intellectual property transfers to client upon final payment."
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <p className="text-sm text-blue-800">
                      All generated contracts include a legal disclaimer and should be reviewed by a qualified attorney before use. This service does not constitute legal advice.
                    </p>
                  </div>
                </div>
